...
| **1.2.0** | 记忆与上下文（OpenViking 替代）+ 收尾优化 | 记忆模块（过程级采集 + 原始 trace + decision 入图 + 记忆管理页）、分层上下文交付、技能沉淀、记忆/知识双轨制、删除笔记功能、共享中心 UI 优化、打包前 5 轮代码优化 | 进行中 |
